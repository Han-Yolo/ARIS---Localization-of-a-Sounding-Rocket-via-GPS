...
This is because a fourth variable needs to be solved for, which is the difference between GPS time and user time called $\delta t_u$.
...
Insted, the difference between receiver time and GPS time is solved for with the measurement from a fourth satellite.
...
GPS solves this problem with a three-layered signal shown in figure \ref{}.
