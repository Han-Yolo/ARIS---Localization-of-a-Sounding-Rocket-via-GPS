...
A controll loop is implemented to determine the position of the airbrakes during the accent.
...
With such an accuracy improvement, the GPS position could be fused together with the pressure and accelerometer data.
The addition of GPS would eseccialy help in reducing the drift introduced by the accelerometer.



However, it is planned to collect GPS raw data to perform post processing differential GPS to analize the flight.
